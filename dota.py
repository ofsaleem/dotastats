...
CACHE = '/var/www/html/cached.html'
...
SITE_TITLES = {
	SITE: """ALL TIME<div class="arrow-down"></div>""",
	SITE_MONTH: """MONTH<div class="arrow-down"></div>""",
	SITE_WEEK: """WEEK<div class="arrow-down"></div>""",
	}
	...
	<head>
		...
		<style>		
		    * {margin: 0;}
			...
			table {border-collapse:collapse; background-color:rgba(255,255,255,0.75); margin-top: 1em; box-shadow: 0px 0px 50px #800000;}
			...
			tr.odd td {background-color: rgba(255,255,255,0.25); }
			tr.even td {background-color: rgba(170,170,170,0.25);}
...
""")
		...
		out("""
					<tr style="background-color:rgba(170,170,170,0.25)";><th></th><th class="center" colspan=2>%s%s</th><th class="center" colspan=2>%s%s</th><th class="center" colspan=2>%s%s</th></tr>
